    ...
    The project located in this directory has been generated by Jeevanandam Madanagopal
    ...
    that a model called 'sample-webservice-andromda' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /sample-webservice-andromda J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Jeevanandam Madanagopal/.m2/repository/sample-webservice-andromda/
