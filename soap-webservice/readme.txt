    ...
    that a model called 'soap-webservice' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /soap-webservice J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Jeevanandam Madanagopal/.m2/repository/soap-webservice/
